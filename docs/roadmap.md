...
> **注記 (2026-04-26)**: 本フェーズは ADR-0002 (`docs/decisions/0002-skip-phase-0.md`) により skip 判断済み。
> rationale: 学生期間中は技術検証を優先し、市場検証は社会人以降に実施する方針。
> Phase 1 内の kill criteria（ADR-0002 §1）で代替監視。Phase 4 ローンチ前に市場検証は必ず再評価する。
